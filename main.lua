...
-----------------------------------------------------------------
---------------------------CUSTOM-SMG----------------------------
local CUSTOMSMG_MAIN = nil
local CUSTOMSMG_HOLOSIGHT = false
local CUSTOMSMG_8X = false
local CUSTOMSMG_16X = false
local CUSTOMSMG_HANDMADE = false
local CUSTOMSMG_SILENCER = false
local CUSTOMSMG_MUZZLEBOOST = false
-----------------------------------------------------------------
---------------------------HMLMG---------------------------------
local HMLMG_MAIN = nil
...
---------------------------SAR-----------------------------------
local SAR_MAIN = nil
local SAR_HOLOSIGHT = false
local SAR_8X = false
local SAR_16X = false
local SAR_HANDMADE = false
local SAR_SILENCER = false
-----------------------------------------------------------------
---------------------------M39-----------------------------------
local M39_MAIN = nil
local M39_HOLOSIGHT = false
local M39_8X = false
local M39_16X = false
local M39_HANDMADE = false
local M39_SILENCER = false
-----------------------------------------------------------------
-----------------------SEMI-AUTOMATIC-PISTOL---------------------
local SAP_MAIN = nil
local SAP_HOLOSIGHT = false
local SAP_8X = false
local SAP_16X = false
local SAP_HANDMADE = false
local SAP_SILENCER = false
-----------------------------------------------------------------
-------------------------M92-BERETTA-----------------------------
local M92_MAIN = nil
...
local M92_8X = false
local M92_16X = false
local M92_HANDMADE = false
local M92_SILENCER = false
-----------------------------------------------------------------
---------------------------PYTHON--------------------------------
local PYTHON_MAIN = nil
local PYTHON_HOLOSIGHT = false
local PYTHON_8X = false
local PYTHON_16X = false
local PYTHON_HANDMADE = false
-----------------------------------------------------------------
---------------------------REVOLVER------------------------------
local REVOLVER_MAIN = nil
local REVOLVER_SILENCER = false
--SETTINGS-------------------------------------------------------
local SENSITIVITY =  0.833 --setar sensibilidade preferida, ou usar o user.sens para o mesmo do local
local FOV = 90 --colocar sua fov
local door_unlocker = nil --setar botão do mouse
local key_code = 0 --setar o code das portas
-----------------------------------------------------------------
...
function nvme14(a)local b=GetRunningTime()+a;repeat until GetRunningTime()>b-1 end
function round(x) return x>=0 and math.floor(x+0.5) or math.ceil(x-0.5) end
function Smoothing(a,b,c)x_=0;y_=0;t_=0;for d=1,a do xI=round(d*b/a)yI=round(d*c/a)tI=d*a/a;MoveMouseRelative(round(xI-x_),round(yI-y_))nvme14(tI-t_)x_=xI;y_=yI;t_=tI end end
...
barrel_1_AK47_1 = 1
barrel_1_AK47_2 = 1
if ASSAULT_RIFLE_HOLOSIGHT == true then
scope_1_AK47_1 = 1.2
end
if ASSAULT_RIFLE_8X == true then
scope_1_AK47_2 = 6.9
end
if ASSAULT_RIFLE_16X == true then
scope_1_AK47_3 = 13.5
end
if ASSAULT_RIFLE_HANDMADE == true then
scope_1_AK47_4 = 0.8
end
if ASSAULT_RIFLE_SILENCER == true then
barrel_1_AK47_1 = 1
end
...
scope_1_LR300_4 = 1
barrel_1_LR300_1 = 1
if LR300_HOLOSIGHT == true then
scope_1_LR300_1 = 1.2
end
if LR300_8X == true then
scope_1_LR300_2 = 6.75
end
if LR300_16X == true then
scope_1_LR300_3 = 13.5
end
if LR300_HANDMADE == true then
scope_1_LR300_4 = 0.8
end
if LR300_SILENCER == true then
barrel_1_LR300_1 = 1
end
if LR300_MUZZLEBOOST == true then
...
scope_1_MP5A4_4 = 1
barrel_1_MP5A4_1 = 1
if MP5_HOLOSIGHT == true then
scope_1_MP5A4_1 = 1.2
end
if MP5_8X == true then
scope_1_MP5A4_2 = 6.75
end
if MP5_16X == true then
scope_1_MP5A4_3 = 13.5
end
if MP5_HANDMADE == true then
scope_1_MP5A4_4 = 0.8
end
if MP5_SILENCER == true then
barrel_1_MP5A4_1 = 1
end
if MP5_MUZZLEBOOST == true then
...
if THOMPSON_HOLOSIGHT == true then
scope_1_THOMPSON_1 = 1.5
end
if THOMPSON_8X == true then
scope_1_THOMPSON_2 = 7.75
end
if THOMPSON_16X == true then
scope_1_THOMPSON_3 = 15.5
end
if THOMPSON_HANDMADE == true then
scope_1_THOMPSON_4 = 0.8
end
if THOMPSON_SILENCER == true then
	if THOMPSON_HOLOSIGHT == true then
...
if THOMPSON_MUZZLEBOOST == true then
...
scope_1_SMG_4 = 1
barrel_1_SMG_1 = 1
if CUSTOMSMG_HOLOSIGHT == true then
scope_1_SMG_1 = 1.5
end
if CUSTOMSMG_8X == true then
scope_1_SMG_2 = 7.75
end
if CUSTOMSMG_16X == true then
scope_1_SMG_3 = 15.5
end
if CUSTOMSMG_HANDMADE == true then
scope_1_SMG_4 = 0.8
end
if CUSTOMSMG_SILENCER == true then
	if CUSTOMSMG_HOLOSIGHT == true then
		barrel_1_SMG_1 = 0.9
	else
		barrel_1_SMG_1 = 1
...
if CUSTOMSMG_MUZZLEBOOST == true then
barrel_1_SMG_2 = 0.9
end
...
scope_1_HMLMG_4 = 1
barrel_1_HMLMG_1 = 1
if HMLMG_HOLOSIGHT == true then
scope_1_HMLMG_1 = 1.2
end
if HMLMG_8X == true then
scope_1_HMLMG_2 = 7
end
if HMLMG_16X == true then
scope_1_HMLMG_3 = 13.5
end
if HMLMG_HANDMADE == true then
scope_1_HMLMG_4 = 0.8
end
if HMLMG_SILENCER == true then
barrel_1_HMLMG_1 = 1
end
...
scope_1_M249_4 = 1
barrel_1_M249_1 = 1
if M249_HOLOSIGHT == true then
scope_1_M249_1 = 1.2
end
if M249_8X == true then
scope_1_M249_2 = 6.95
end
if M249_16X == true then
scope_1_M249_3 = 13.9
end
if M249_HANDMADE == true then
scope_1_M249_4 = 0.8
end
if M249_SILENCER == true then
barrel_1_M249_1 = 1
end
...
scope_1_SAR_4 = 1
barrel_1_SAR_1 = 1
if SAR_HOLOSIGHT == true then
scope_1_SAR_1 = 1.2
end
if SAR_8X == true then
scope_1_SAR_2 = 6.75
end
if SAR_16X == true then
scope_1_SAR_3 = 13.5
end
if SAR_HANDMADE == true then
scope_1_SAR_4 = 0.8
end
if SAR_SILENCER == true then
barrel_1_SAR_1 = 1
end
...
scope_1_M39_4 = 1
barrel_1_M39_1 = 1
if M39_HOLOSIGHT == true then
scope_1_M39_1 = 1.5
end
if M39_8X == true then
scope_1_M39_2 = 9.75
end
if M39_16X == true then
scope_1_M39_3 = 13.5
end
if M39_HANDMADE == true then
scope_1_M39_4 = 0.9
end
if M39_SILENCER == true then
barrel_1_M39_1 = 1
end
...
scope_1_SAP_4 = 1
barrel_1_SAP_1 = 1
if SAP_HOLOSIGHT == true then
scope_1_SAP_1 = 1.5
end
if SAP_8X == true then
scope_1_SAP_2 = 9.75
end
if SAP_16X == true then
scope_1_SAP_3 = 13.5
end
if SAP_HANDMADE == true then
scope_1_SAP_4 = 0.8
end
if SAP_SILENCER == true then
barrel_1_SAP_1 = 1
end
...
scope_1_M92_4 = 1
barrel_1_M92_1 = 1
if M92_HOLOSIGHT == true then
scope_1_M92_1 = 1.7
end
if M92_8X == true then
scope_1_M92_2 = 9.75
end
if M92_16X == true then
scope_1_M92_3 = 13.5
end
if M92_HANDMADE == true then
scope_1_M92_4 = 0.8
end
if M92_SILENCER == true then
barrel_1_M92_1 = 1
end
...
scope_1_PYTHON_4 = 1
barrel_1_PYTHON_1 = 1
if PYTHON_HOLOSIGHT == true then
scope_1_PYTHON_1 = 1.5
end
if PYTHON_8X == true then
scope_1_PYTHON_2 = 9.75
end
if PYTHON_16X == true then
scope_1_PYTHON_3 = 13.5
end
if PYTHON_HANDMADE == true then
...
--ASSAULT-RIFLE
	if (event == "MOUSE_BUTTON_PRESSED" and arg == ASSAULT_RIFLE_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("ASSAULT_RIFLE_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("ASSAULT_RIFLE_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--LR300
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == LR300_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("LR300_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("LR300_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--MP5
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == MP5_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("MP5_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("MP5_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--THOMPSON
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == THOMPSON_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("THOMPSON_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("THOMPSON_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--CUSTOM-SMG
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == CUSTOMSMG_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("CUSTOMSMG_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("CUSTOMSMG_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--HMLMG
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == HMLMG_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("HMLMG_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("HMLMG_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--M249
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == M249_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("M249_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("M249_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--SAR
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == SAR_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("SAR_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("SAR_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--REVOLVER
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == REVOLVER_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("REVOLVER_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("REVOLVER_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--M39
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == M39_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("M39_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("M39_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--SAP
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == SAP_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("SAP_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("SAP_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--M92
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == M92_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("M92_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("M92_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
--PYTHON
	elseif (event == "MOUSE_BUTTON_PRESSED" and arg == PYTHON_MAIN) then
		kickback = not kickback
		gun = arg
		if (kickback == false) then
			OutputLogMessage("PYTHON_MAIN_MACRO-OFF\n")
		else
			OutputLogMessage("PYTHON_MAIN_MACRO-ON\n")
			EnablePrimaryMouseButtonEvents(true)
		end
	end
	local bullet_ = 1
...
--MOVE_EVENT-----------------------------------------------------
	if gun == ASSAULT_RIFLE_MAIN then
		if kickback then
					...
					for maincycle = bullet_, AK47_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_AK47_ST[bullet_] ~= 0) then nvme14(N1_AK47_ST[bullet_]) end
							else
					...
					repeat
						if AK47_1_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_AK47_ST[#N1_AK47_ST] ~= 0) then nvme14(N1_AK47_ST[#N1_AK47_ST]) end
							else
					...
					for maincycle = bullet_, LR300_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_LR300_ST[bullet_] ~= 0) then nvme14(N1_LR300_ST[bullet_]) end
							else
					...
					repeat
						if LR300_1_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_LR300_ST[#N1_LR300_ST] ~= 0) then nvme14(N1_LR300_ST[#N1_LR300_ST]) end
							else
					...
					for maincycle = bullet_, MP5A4_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_MP5A4_ST[bullet_] ~= 0) then nvme14(N1_MP5A4_ST[bullet_]) end
							else
					...
					repeat
						if MP5A4_1_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_MP5A4_ST[#N1_MP5A4_ST] ~= 0) then nvme14(N1_MP5A4_ST[#N1_MP5A4_ST]) end
							else
	...
	elseif gun == CUSTOMSMG_MAIN then
		if kickback then
			if (IsMouseButtonPressed(3)) then
				nvme14(5)
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, SMG_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_SMG_ST[bullet_] ~= 0) then nvme14(N1_SMG_ST[bullet_]) end
							else
					...
					repeat
						if SMG_1_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_SMG_ST[#N1_SMG_ST] ~= 0) then nvme14(N1_SMG_ST[#N1_SMG_ST]) end
							else
					...
					for maincycle = bullet_, THOMPSON_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_THOMPSON_ST[bullet_] ~= 0) then nvme14(N1_THOMPSON_ST[bullet_]) end
							else
					...
					repeat
						if THOMPSON_1_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_THOMPSON_ST[#N1_THOMPSON_ST] ~= 0) then nvme14(N1_THOMPSON_ST[#N1_THOMPSON_ST]) end
							else
							...
							if (IsModifierPressed("lctrl")) then
								if (HMLMG_1_X8_SCOPE == true) then
									if (maincycle > 31) then
										...
										if (N1_HMLMG_ST[bullet_] ~= 0) then nvme14(N1_HMLMG_ST[bullet_]) end
									else
			...
			if (IsMouseButtonPressed(3)) then
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, M249_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								if (M249_1_X8_SCOPE == true) or (M249_1_X16_SCOPE == true) then
									if (maincycle > 32) then
										Smoothing(N1_M249_AT[bullet_], 0, N1_M249_C_Y[bullet_])
										if (N1_M249_ST[bullet_] ~= 0) then nvme14(N1_M249_ST[bullet_]) end
									else
										Smoothing(N1_M249_AT[bullet_], N1_M249_C_X[bullet_], N1_M249_C_Y[bullet_])
										if (N1_M249_ST[bullet_] ~= 0) then nvme14(N1_M249_ST[bullet_]) end
									end
								else
									if (maincycle > 47) then
										Smoothing(N1_M249_AT[bullet_], 0, N1_M249_C_Y[bullet_])
										if (N1_M249_ST[bullet_] ~= 0) then nvme14(N1_M249_ST[bullet_]) end
									else
										Smoothing(N1_M249_AT[bullet_], N1_M249_C_X[bullet_], N1_M249_C_Y[bullet_])
								...
								if (M249_1_X8_SCOPE == true) or (M249_1_X16_SCOPE == true) then
									if (maincycle > 17) then
										Smoothing(N1_M249_AT[bullet_], 0, N1_M249_C_Y[bullet_]*StandMultiplier_M2)
										if (N1_M249_ST[bullet_] ~= 0) then nvme14(N1_M249_ST[bullet_]) end
									else
										Smoothing(N1_M249_AT[bullet_], N1_M249_C_X[bullet_]*StandMultiplier_M2, N1_M249_C_Y[bullet_]*StandMultiplier_M2)
										if (N1_M249_ST[bullet_] ~= 0) then nvme14(N1_M249_ST[bullet_]) end
									end
								else
									if (maincycle > 24) then
										Smoothing(N1_M249_AT[bullet_], 0, N1_M249_C_Y[bullet_]*StandMultiplier_M2)
										if (N1_M249_ST[bullet_] ~= 0) then nvme14(N1_M249_ST[bullet_]) end
									else
										Smoothing(N1_M249_AT[bullet_], N1_M249_C_X[bullet_]*StandMultiplier_M2, N1_M249_C_Y[bullet_]*StandMultiplier_M2)
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, SAR_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_SAR_ST[bullet_] ~= 0) then nvme14(N1_SAR_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					repeat
						if (IsModifierPressed("lctrl")) then
							...
							if (N1_SAR_ST[#N1_SAR_ST] ~= 0) then nvme14(N1_SAR_ST[#N1_SAR_ST]) end
						else
					...
					for maincycle = bullet_, M39_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_M39_ST[bullet_] ~= 0) then nvme14(N1_M39_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, SAP_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_SAP_ST[bullet_] ~= 0) then nvme14(N1_SAP_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					repeat
						if (IsModifierPressed("lctrl")) then
							...
							if (N1_SAP_ST[#N1_SAP_ST] ~= 0) then nvme14(N1_SAP_ST[#N1_SAP_ST]) end
						else
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, M92_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_M92_ST[bullet_] ~= 0) then nvme14(N1_M92_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					repeat
						if (IsModifierPressed("lctrl")) then
							...
							if (N1_M92_ST[#N1_M92_ST] ~= 0) then nvme14(N1_M92_ST[#N1_M92_ST]) end
						else
					...
					for maincycle = bullet_, PYTHON_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_PYTHON_ST[bullet_] ~= 0) then nvme14(N1_PYTHON_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
	...
	elseif gun == ASSAULT_RIFLE_MAIN then
		if kickback then
			if (IsMouseButtonPressed(3)) then
				nvme14(5)
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, AK47_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_AK47_ST[bullet_] ~= 0) then nvme14(N2_AK47_ST[bullet_]) end
							else
								if ASSAULT_RIFLE_MUZZLEBOOST == true then
									if (bullet_ > 17) then
					...
					repeat
						if ASSAULT_RIFLE_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_AK47_ST[#N2_AK47_ST] ~= 0) then nvme14(N2_AK47_ST[#N2_AK47_ST]) end
							else
					...
					for maincycle = bullet_, LR300_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_LR300_ST[bullet_] ~= 0) then nvme14(N2_LR300_ST[bullet_]) end
							else
								if LR300_MUZZLEBOOST == true then
									if (bullet_ > 17) then
					...
					repeat
						if LR300_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_LR300_ST[#N2_LR300_ST] ~= 0) then nvme14(N2_LR300_ST[#N2_LR300_ST]) end
							else
					...
					for maincycle = bullet_, MP5A4_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_MP5A4_ST[bullet_] ~= 0) then nvme14(N2_MP5A4_ST[bullet_]) end
							else
								if MP5_MUZZLEBOOST == true then
									if (bullet_ > 17) then
					...
					repeat
						if MP5_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_MP5A4_ST[#N2_MP5A4_ST] ~= 0) then nvme14(N2_MP5A4_ST[#N2_MP5A4_ST]) end
							else
					...
					for maincycle = bullet_, SMG_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_SMG_ST[bullet_] ~= 0) then nvme14(N2_SMG_ST[bullet_]) end
							else
								if CUSTOMSMG_MUZZLEBOOST == true then
									if (bullet_ > 17) then
					...
					repeat
						if CUSTOMSMG_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_SMG_ST[#N2_SMG_ST] ~= 0) then nvme14(N2_SMG_ST[#N2_SMG_ST]) end
							else
					...
					for maincycle = bullet_, THOMPSON_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_THOMPSON_ST[bullet_] ~= 0) then nvme14(N2_THOMPSON_ST[bullet_]) end
							else
								if THOMPSON_MUZZLEBOOST == true then
									if (bullet_ > 17) then
					...
					repeat
						if THOMPSON_MUZZLEBOOST == true then
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_THOMPSON_ST[#N2_THOMPSON_ST] ~= 0) then nvme14(N2_THOMPSON_ST[#N2_THOMPSON_ST]) end
							else
							...
							if (IsModifierPressed("lctrl")) then
								if (HMLMG_8X == true) then
									if (maincycle > 31) then
										...
										if (N2_HMLMG_ST[bullet_] ~= 0) then nvme14(N2_HMLMG_ST[bullet_]) end
									else
			...
			if (IsMouseButtonPressed(3)) then
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, M249_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								if (M249_8X == true) or (M249_16X == true) then
									if (maincycle > 32) then
										Smoothing(N2_M249_AT[bullet_], 0, N2_M249_C_Y[bullet_])
										if (N2_M249_ST[bullet_] ~= 0) then nvme14(N2_M249_ST[bullet_]) end
									else
								...
								if (M249_8X == true) or (M249_16X == true) then
									if (maincycle > 17) then
										Smoothing(N2_M249_AT[bullet_], 0, N2_M249_C_Y[bullet_]*StandMultiplier_M2)
										if (N2_M249_ST[bullet_] ~= 0) then nvme14(N2_M249_ST[bullet_]) end
									else
										Smoothing(N2_M249_AT[bullet_], N2_M249_C_X[bullet_]*StandMultiplier_M2, N2_M249_C_Y[bullet_]*StandMultiplier_M2)
										if (N2_M249_ST[bullet_] ~= 0) then nvme14(N2_M249_ST[bullet_]) end
									end
								else
									if (maincycle > 24) then
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, SAR_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_SAR_ST[bullet_] ~= 0) then nvme14(N2_SAR_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					repeat
						if (IsModifierPressed("lctrl")) then
							...
							if (N2_SAR_ST[#N2_SAR_ST] ~= 0) then nvme14(N2_SAR_ST[#N2_SAR_ST]) end
						else
					...
					for maincycle = bullet_, M39_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_M39_ST[bullet_] ~= 0) then nvme14(N2_M39_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, SAP_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_SAP_ST[bullet_] ~= 0) then nvme14(N2_SAP_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					repeat
						if (IsModifierPressed("lctrl")) then
							...
							if (N2_SAP_ST[#N2_SAP_ST] ~= 0) then nvme14(N2_SAP_ST[#N2_SAP_ST]) end
						else
				...
				if (IsMouseButtonPressed(1)) then
					for maincycle = bullet_, M92_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_M92_ST[bullet_] ~= 0) then nvme14(N2_M92_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					repeat
						if (IsModifierPressed("lctrl")) then
							...
							if (N2_M92_ST[#N2_M92_ST] ~= 0) then nvme14(N2_M92_ST[#N2_M92_ST]) end
						else
					...
					for maincycle = bullet_, PYTHON_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N2_PYTHON_ST[bullet_] ~= 0) then nvme14(N2_PYTHON_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
					...
					for maincycle = bullet_, REVOLVER_BULLETS do
						...
						if (IsLeftNotPressed()) then return end
							if (IsModifierPressed("lctrl")) then
								...
								if (N1_REVOLVER_ST[bullet_] ~= 0) then nvme14(N1_REVOLVER_ST[bullet_]) end
							else
								PressKey("pause")
								nvme14(10)
								ReleaseKey("pause")
